    ...
    return (
        <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden pt-20">
            ...
            <div className="container px-4 md:px-6 relative z-10 flex flex-col items-center text-center">
                ...
                <h1 className="animate-fade-in-up [animation-delay:300ms] opacity-0 text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6">
                    Looking to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">Gamify</span> <br />
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Trading?</span>
                </h1>

                <h2 className="animate-fade-in-up [animation-delay:350ms] opacity-0 text-xl md:text-2xl font-medium text-white/90 mb-6">
                    You've found the right player.
                </h2>
                ...
                <p className="animate-fade-in-up [animation-delay:400ms] opacity-0 max-w-2xl text-lg md:text-xl text-neutral-400 mb-10 leading-relaxed">
                    I don't just write code; I <span className="text-white/80 italic">glitch the matrix</span>.
                    Specializing in thinking outside the voxel to turn complex logic into engaging, winning experiences.
                </p>
